...
我手头有法务给的 PDF 合同模板，但最终希望应用能输出 Word（.docx）文件，把用户填写的数据写入标准合同正文。`,
  ...
  },
  {
    ...
    description:
      '物理交互实验：摄像头镜面 + 自定义背景媒体 + Verlet 液态幕布，两指捏合/上抛/下甩手势控制。',
    features: [
      '全屏前置摄像头实时镜面',
      '自定义背景图片/视频',
      'Verlet 物理液态幕布',
      'MediaPipe 手势：捏合抓持、上抛掀起、下甩落回',
      '电视幕布 / 撕保鲜膜等模式',
    ],
    initial_prompt: '【待补充首批提示词】',
    tech_tags: ['p5.js', 'MediaPipe', 'Verlet', '交互实验'],
    ai_path: 1,
    screenshot_url: '/portfolio/liquid-veil.svg',
    featured: true,
    sort_order: 3,
  },
  {
    ...
    title: 'QAZ AI 音乐创作工坊',
    tagline: '歌词灵感 · 风格提示词 · 多平台创作入口',
    url: 'https://sage-eclair-192ed1.netlify.app/',
    description:
      '聚合歌词灵感引擎、风格提示词生成，对接 Suno、妙响等平台，展示代表作品集。',
    features: [
      '歌词灵感引擎',
      '风格提示词生成',
      'Suno / 妙响创作平台入口',
    ...
    ai_path: 2,
    screenshot_url: '/portfolio/qaz-music.svg',
    featured: false,
    sort_order: 4,
  },
];
